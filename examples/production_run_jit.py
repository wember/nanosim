...
Performance:
  ...
  Production run (n=1000000, s=10000, r=11, m=5):
    ...
    type_group.add_argument(
        "--irreversible", action="store_true", help="Run irreversible simulation"
    )
    ...
    try:
        ...
        print("=" * 70)
        irr_prefix = "irr/" if args.irreversible else ""
        print(f"Results written to: data/{irr_prefix}r[1..{args.r-1}]/")
        print("\nNext steps:")
