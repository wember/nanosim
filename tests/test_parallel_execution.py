...
class TestCoreDetection:
    ...
    def test_core_override_logic(self):
...
class TestParallelWorkerFunction:
    ...
    def test_irreversible_worker_runs(self):
...
class TestParallelVsSequential:
    ...
    def test_multiple_workers_produce_different_results(self):
...
class TestParallelOutputStructure:
    ...
    def test_reversible_output_structure(self):
    ...
    def test_irreversible_output_structure(self):
...
class TestParallelResourceManagement:
    ...
    def test_worker_handles_different_radii(self):
    ...
    def test_worker_validation_modes(self):
...
class TestParallelCorrectness:
    ...
    def test_energy_conservation_all_workers(self):
    ...
    def test_worker_memory_footprint_reasonable(self):
...
class TestParallelEdgeCases:
    ...
    def test_single_simulation_parallel(self):
