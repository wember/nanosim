...
class TestJITInfernoCorrectness:
    ...
    def test_jit_inferno_reversibility(self):
        ...
        initial_energy = jit.E_total
        initial_lattice_energy = jit.E_lattice
        initial_demon_energy = jit.E_demon_sum
...
class TestJITirrInfernoCorrectness:
    ...
    def test_jit_irr_inferno_irreversibility(self):
        ...
        assert not np.array_equal(jit.lattice, initial_lattice), \
        ...
        for _ in range(30):
            ...
            for i in range(N):
                if jit.bonds[i] != 0:
                    ...
                    assert jit.bonds[i] == expected_bond, \
...
class TestJITStateConsistency:
    ...
    def test_jit_demon_energy_sum_consistency(self):
        ...
        for _ in range(30):
            ...
            assert jit.E_demon_sum == actual_sum, \
...
class TestJITAPI:
    ...
    def test_jit_inferno_same_attributes(self):
        ...
        for attr in ['N', 'R', 'lattice', 'bonds', 'bond_count', 
                     'E_demon', 'E_demon_sum', 'E_lattice', 'E_total',
                     'right_neighbor', 'left_neighbor', 'order', 'rev_order']:
