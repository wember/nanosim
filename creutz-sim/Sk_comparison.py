...
Compares entropy (S/Nk) evolution between reversible and irreversible simulations
across different demon-coupling radii (R=0 to R=10).
...
# Create 2x2 subplot grid: [full data, smoothed] on top row, [zoomed, zoomed smoothed] on bottom
...
fig.update_layout(title_text=f"Entropy Comparison: Reversible vs Irreversible (Lattice Size: {n})")
fig.show()
