"""Parallel implementation of reversible Creutz demon simulation.
...
def run_single_simulation(
    ...
    if R == 0:
        ...
        filename = os.path.join(output_dir, f"sim_data_{M}.csv")
    else:
        output_dir = os.path.join(folder, f"r{R}")
        filename = os.path.join(output_dir, f"sim_data_r{R}_{M}.csv")
    ...
    metadata = {
        ...
        "simulation_type": "reversible_parallel",
    }
...
if __name__ == "__main__":
    ...
    logging.info(
        f"Starting parallel reversible simulation: n={n}, s={s}, r={r}, "
