...
Usage:
    python profile_sim.py [--mode {inferno,irr_inferno}] [--n N] [--s SWEEPS] [--r RADIUS]
"""
...
def main():
    ...
    parser.add_argument('--mode', choices=['inferno', 'irr_inferno'], 
                        default='inferno', help='Simulation mode to profile')
    parser.add_argument('--n', type=int, default=10000, 
                        help='Lattice size (default: 10000)')
    parser.add_argument('--s', type=int, default=100,
                        help='Number of sweeps (default: 100)')
    parser.add_argument('--r', type=int, default=5,
                        help='Demon coupling radius (default: 5)')
    parser.add_argument('--both', action='store_true',
                        help='Profile both Inferno and irrInferno')
