...
echo "    make run-sim          # Production (parallel JIT)"
echo "    make run-irr-sim      # Production (parallel JIT)"
echo "    python creutz-sim/legacy/sim.py      # Legacy single-core"
echo "    python creutz-sim/legacy/irr_sim.py  # Legacy single-core"
